...
seulement la 1ère) : Jazz Bass = 2 Volumes + 1 Tone ; Precision = 1 Volume +
1 Tone. L'utilisateur peut sélectionner n'importe quelle guitare/basse du rig
dans l'app → chacune doit avoir ses propres "controls".
