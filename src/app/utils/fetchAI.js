...
Pour CHAQUE guitare retournée, ajoute "controls" = réglages des VRAIS contrôles
de CE modèle pour le morceau : "selector" (position du sélecteur de micro,
ex. "Position 4 (manche+intermédiaire)" ; "" si mono-micro/N.A.) + "knobs"
(liste {name, value 0-10} des boutons réels) + "why" (1 phrase trilingue).
Adapte au layout réel : Stratocaster = sélecteur 5 positions + 1 Volume + 2 Tone ;
Les Paul/SG = 3 positions + 2 Volumes + 2 Tone ; Telecaster = 3 positions + 1 Volume
+ 1 Tone ; guitare 1 micro = pas de sélecteur. Idem pour les basses (cot_step2_basses) :
Jazz Bass = 2 Volumes + 1 Tone ; Precision = 1 Volume + 1 Tone.
