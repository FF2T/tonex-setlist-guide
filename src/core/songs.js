...
// Phase 7.40 — `desc` devient un objet trilingue {fr, en, es}. Le helper
// getLocalizedText(info.desc, locale) côté UI décode (HomeScreen,
// SongDetailCard, SetlistPdfExport).
const INIT_SONG_DB_META = [
  {id:"acdc_hth",title:"Highway to Hell",artist:"AC/DC",year:1979,album:"Highway to Hell",bpm:116,key:"A",desc:{fr:"Le riff d'ouverture le plus iconique du hard rock. Angus Young en SG sur un Marshall, le son brut du rock australien.",en:"The most iconic opening riff in hard rock. Angus Young on his SG through a Marshall — the raw sound of Australian rock.",es:"El riff de apertura más icónico del hard rock. Angus Young con su SG en un Marshall, el sonido crudo del rock australiano."}},
  {id:"acdc_ysmanll",title:"You Shook Me All Night Long",artist:"AC/DC",year:1980,album:"Back in Black",bpm:127,key:"G",desc:{fr:"Le groove parfait d'AC/DC. Riff en La majeur, son crunchy et rythmique imparable.",en:"AC/DC's perfect groove. A major riff, crunchy tone and unstoppable rhythm.",es:"El groove perfecto de AC/DC. Riff en La mayor, sonido crunchy y ritmo imparable."}},
  {id:"acdc_thunderstruck",title:"Thunderstruck",artist:"AC/DC",year:1990,album:"The Razors Edge",bpm:134,key:"B minor",desc:{fr:"L'intro en tapping d'Angus Young sur une seule corde. Technique et énergie à l'état pur.",en:"Angus Young's single-string tapping intro. Pure technique and energy.",es:"La intro en tapping de Angus Young sobre una sola cuerda. Técnica y energía puras."}},
  {id:"acdc_tnt",title:"TNT",artist:"AC/DC",year:1975,album:"T.N.T.",bpm:128,key:"A",desc:{fr:"Riff simple et efficace en power chords. L'essence du rock'n'roll : 3 accords et la vérité.",en:"Simple and effective power-chord riff. The essence of rock'n'roll: 3 chords and the truth.",es:"Riff simple y eficaz con power chords. La esencia del rock'n'roll: 3 acordes y la verdad."}},
  {id:"acdc_bib",title:"Back in Black",artist:"AC/DC",year:1980,album:"Back in Black",bpm:92,key:"E",desc:{fr:"L'album le plus vendu d'AC/DC. Le riff en Mi est devenu un standard du rock mondial.",en:"AC/DC's best-selling album. The E riff became a worldwide rock standard.",es:"El álbum más vendido de AC/DC. El riff en Mi se convirtió en un estándar del rock mundial."}},
  {id:"cream_wr",title:"White Room",artist:"Cream",year:1968,album:"Wheels of Fire",bpm:116,key:"D minor",desc:{fr:"Clapton à la wah-wah sur un riff psychédélique. Le son du blues-rock britannique des sixties.",en:"Clapton on wah-wah over a psychedelic riff. The sound of 60s British blues-rock.",es:"Clapton con wah-wah sobre un riff psicodélico. El sonido del blues-rock británico de los sesenta."}},
  {id:"bbking_thrill",title:"The Thrill Is Gone",artist:"B.B. King",year:1969,album:"Completely Well",bpm:96,key:"B minor",desc:{fr:"Le chef-d'œuvre de B.B. King. Vibrato légendaire sur Lucille, le son du blues moderne.",en:"B.B. King's masterpiece. Legendary vibrato on Lucille, the sound of modern blues.",es:"La obra maestra de B.B. King. Vibrato legendario sobre Lucille, el sonido del blues moderno."}},
  {id:"dire_mfn",title:"Money for Nothing",artist:"Dire Straits",year:1985,album:"Brothers in Arms",bpm:136,key:"G",desc:{fr:"Le riff de Knopfler aux doigts (pas de médiator). Son Gibson Les Paul dans un Laney amplifié.",en:"Knopfler's fingerstyle riff (no pick). Gibson Les Paul tone through a cranked Laney.",es:"El riff de Knopfler tocado con los dedos (sin púa). Sonido Gibson Les Paul en un Laney amplificado."}},
  {id:"dire_romeo",title:"Romeo & Juliet",artist:"Dire Straits",year:1980,album:"Making Movies",bpm:138,key:"F",desc:{fr:"Fingerpicking délicat de Knopfler sur une National steel guitar. Ballade folk-rock intemporelle.",en:"Knopfler's delicate fingerpicking on a National steel guitar. A timeless folk-rock ballad.",es:"Fingerpicking delicado de Knopfler sobre una National steel guitar. Balada folk-rock atemporal."}},
  {id:"ledzep_stairway",title:"Stairway to Heaven",artist:"Led Zeppelin",year:1971,album:"Led Zeppelin IV",bpm:72,key:"A minor",desc:{fr:"Progression de l'arpège acoustique au solo électrique légendaire de Jimmy Page. Le morceau de guitare par excellence.",en:"Progression from acoustic arpeggio to Jimmy Page's legendary electric solo. The quintessential guitar song.",es:"Progresión del arpegio acústico al solo eléctrico legendario de Jimmy Page. La canción de guitarra por excelencia."}},
...
// Phase 7.40 — `effects` devient un objet trilingue {fr, en, es}. Le
// helper `getLocalizedText(song.effects, locale)` côté UI décode. Les
// noms propres (guitarist, guitar, amp) restent en string FR car ce
// sont des modèles/noms historiques (les annotations FR mineures type
// "(ébène)" → "(ebony)" / "(ébano)" ne valent pas la complexité d'un
// objet trilingue par champ).
const SONG_HISTORY = {
  acdc_hth:          {guitarist:"Angus Young",     guitar:"Gibson SG Custom (ébène)",                   amp:"Marshall Super Lead 100W",            effects:{fr:"Aucun effet — directement dans l'ampli à fond",en:"No effect — straight into the amp on full",es:"Ningún efecto — directamente al ampli a fondo"}},
  acdc_ysmanll:      {guitarist:"Angus Young",     guitar:"Gibson SG Custom",                           amp:"Marshall Super Lead 100W",            effects:{fr:"Aucun effet",en:"No effect",es:"Ningún efecto"}},
  acdc_thunderstruck:{guitarist:"Angus Young",     guitar:"Gibson SG Custom",                           amp:"Marshall Super Lead 100W",            effects:{fr:"Aucun effet — intro en tapping en picking",en:"No effect — picking-style tapping intro",es:"Ningún efecto — intro en tapping con púa"}},
  acdc_tnt:          {guitarist:"Angus Young",     guitar:"Gibson SG (standard)",                       amp:"Marshall Super Lead 100W",            effects:{fr:"Aucun effet",en:"No effect",es:"Ningún efecto"}},
  acdc_bib:          {guitarist:"Angus Young",     guitar:"Gibson SG Custom",                           amp:"Marshall Super Lead 100W",            effects:{fr:"Aucun effet — enr. aux Compass Point Studios (Bahamas)",en:"No effect — recorded at Compass Point Studios (Bahamas)",es:"Ningún efecto — grabado en Compass Point Studios (Bahamas)"}},
  cream_wr:          {guitarist:"Eric Clapton",    guitar:"Gibson SG Standard «The Fool» (peinte)",     amp:"Marshall JTM45 / Super Lead",         effects:{fr:"Wah-wah Vox Clyde McCoy (intro & solo)",en:"Vox Clyde McCoy wah-wah (intro & solo)",es:"Wah-wah Vox Clyde McCoy (intro y solo)"}},
  bbking_thrill:     {guitarist:"B.B. King",       guitar:"Gibson ES-355 «Lucille»",                    amp:"Fender Super Reverb",                 effects:{fr:"Réverb spring, vibrato ES-355, léger delay studio",en:"Spring reverb, ES-355 vibrato, light studio delay",es:"Reverb spring, vibrato ES-355, ligero delay de estudio"}},
  dire_mfn:          {guitarist:"Mark Knopfler",   guitar:"Schecter Telecaster (humbuckers)",           amp:"Mesa Boogie Mark II",                 effects:{fr:"Roland SDD-320 Dimension D (chorus), jeu aux doigts",en:"Roland SDD-320 Dimension D (chorus), fingerstyle",es:"Roland SDD-320 Dimension D (chorus), tocado con los dedos"}},
  dire_romeo:        {guitarist:"Mark Knopfler",   guitar:"Fender Stratocaster",                        amp:"Music Man HD130",                     effects:{fr:"Léger delay studio, jeu aux doigts",en:"Light studio delay, fingerstyle",es:"Ligero delay de estudio, tocado con los dedos"}},
  ledzep_stairway:   {guitarist:"Jimmy Page",      guitar:"Martin D-28 (intro) · Gibson Les Paul '59 «No.1» (solo)",amp:"Marshall Super Lead · Hiwatt Custom 100",effects:{fr:"Écho à bande Binson Echorec, Leslie speaker (studio)",en:"Binson Echorec tape echo, Leslie speaker (studio)",es:"Eco de cinta Binson Echorec, altavoz Leslie (estudio)"}},
