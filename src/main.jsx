...
function loadSharedKey(){
  return fetch(FS_BASE+"/config/apikeys?key="+FS_KEY)
    ...
    .then(function(doc){if(doc&&doc.fields&&doc.fields.gemini)DEFAULT_GEMINI_KEY=doc.fields.gemini.stringValue;})
    .catch(function(){});
}
...
const TSR_PACK_ZIPS = {
  "50-51":"TSR-50-51-TONEX-Pack-ithoaj","Ampeg Pro 4":"TSR-A-Peg-Pro-4-TONEX-Pack--xqj9tk","Amp Nation ODR":"TSR-Amp-Nation-ODR-0yt0ig","Amp Nation WOD":"TSR-Amp-Nation-WOD-bxkixg","Ample Betty":"TSR-Ample-Betty","Bass Elliot":"TSR-Bass-Elliot-yp8vl7","Bass Pack 1":"TSR-The-Bass-Pack-1-w8fa9b","Bogner Ecstasy 101B":"TSR-Bogner-Ecstasy-101B-wjmrhd","Bogner G-Finger":"TSR-Bogy-GFINGER-Tonex-23sa3p","Bogner Helioclipse":"TSR-Bogy-Helioclipse","British Chime (Budda V20)":"TSR-British-Chime-Pack-zni3bq","British Rock (Vox DC30)":"TSR-British-Rock-Pack-lzwcob","Bumble Deluxe":"TSR-Bumble-Dluxe-fakul2","Cat Cub":"TSR-CAT-CUB-Pack-oqqm9q","Chandler GAV19T":"American-Pack-1-j9zcnx","Cornford Harlequin":"TSR-Cornfield-Harle-dp9nw5","D13":"TSR-D13-Pack","D13 AMP39":"TSR-D13-AMP39-TONEX-Pack-hl0ehr","D13 Best Tweed":"TSR-D13-Pack","Deity (Ironlung)":"TSR-Deity-Pack","Deluxe Reverb II":"TSR-Dlux-Verb-II-3yvqet","Diesel Humbert":"TSR-Diesel-Humbert-8hukym","Drive Pedal Pack 3":"TSR-Drive-Pedal-Pack-3-wk09fp","Electro Dime":"TSR-Electro-Dime-TONEX-Pack-loehp2","Fender Blackface Bassman":"TSR-TONEX-Blackface-Pack--lzzfed","Fender Concert":"TSR-FNDR-Consert-z4zidm","Fender Silverface Twin":"TSR-The-Silverface-Pack-juvwgv","Fender Super S":"TSR-Super-S-a4ad1n","Friedman BE/DE":"TSR-Freeman-BE-DE-id5zii","Friedman Phil X":"Friedman-Phil-X-cnnnxx","GK MBS150 (Bass)":"TSR-GK-MBS150-TONEX-hksx95","Hiwatt HG100":"TSR-High-What-HG100-q28r50","Hiwatt Wizard":"TSR-HOKK-PACK-iy5xyz","Indi 35-2":"TSR-INDI-35-2-9nxtpt","Jimi Hendrix 20W":"TSR-Jimi-H-20-TONEX-qhxcsu","Jivey Drives":"TSR-Jivey-Drives-vrb7o5","Jivey Drives 2":"Jivey-Drives-2-6u19yp","Marshall 800 SL":"TSR-Mars-800SL-TONEX-Pack-a6hrsy","Marshall JCM900":"TSR-Mars-900-JCM-900-1aovpo","Marshall JTM":"TSR-JTM-Pack","Marshall Plexi":"TSR-Plexi-Pack","Marshall SLT60":"TSR-Mars-SLT60-TONEX-Pack-dhqozw","Matchless HC15":"TSR-Tonex-MATCHBOX-HC15-PACK-wthh21","Matchless Independence":"TSR-Matchbox-Pack","Mega Barba Skill":"MEGA-BARBA-SKILL-gitill","Mesa Boogie IIC+":"TSR-MBoogie-IIC-ii0r3b","Mesa Rectifier":"TSR-Rectified--6eqai9","Amplifonics & Gain":"TSR-TONEX-Aliphonivs-And-Gain-Pack-v4mzay","Reinhardt RT-36":"TSR-Reinguard-RT-36-TONEX-uk0r7i","Roland JC":"TSR-JC-Pack-jchfsq","Rouge Plate D50":"TSR-Rouge-Plate-ofucpf","Silver Jubilee":"TSR-Silver-J-Pack-1ykk0n","Soldano 100":"TSR-SLODANO-100-l7ppmu","Soldano GP77":"TSR-SLODANO-GP77-05bqpx","Sons Amp":"TSR-Sons-Amp-TONEX-Pack-2-ealhrl","Synergy SYN 30":"American-Pack-1-j9zcnx","Talon 50":"TSR-Talon-50-nqmscm","TSR20":"TSR-TSR20-mmb5hz","Tube King Imp MK2":"TSR-Tube-King-Imp-MK2-2g9lph","TWS 2864-S":"TWS-2864-S-Pack-yspvyu","Two Rock Bloomfield":"TSR-TWO-ROCK-Bloomfield-Drive-Pack-84jzuk","Two Rock Stevie G":"TSR-Stevie-G-jrfy9q","VMP-1":"TSR-VMP-1--5i4ehm","Zwrek":"TSR-ZWREK-TONEX-Pack",
};

// Regroupement des packs TSR par famille d'ampli
...
function ScoreWithBreakdown({score,breakdown,size}){
  ...
  return(
    <span ref={ref} style={{position:"relative",display:"inline-block"}}>
      ...
      {open&&<div style={{position:"absolute",bottom:"120%",left:0,zIndex:999,background:"var(--bg-card)",border:"1px solid var(--a12)",borderRadius:"var(--r-md)",padding:"8px 10px",fontSize:10,whiteSpace:"nowrap",boxShadow:"var(--shadow-md)",minWidth:160}}>
...
// ─── Scoring V2 : 5 dimensions normalisées 0-100 ────────────────────────────
...
// Matcher tolérant pour aligner un nom renvoyé par l'IA (ideal_guitar, cot_step2_guitars[].name)
...
function PBlock({device,emoji,presetName,gType,banks,adapted,gs,bg2,availableSources,guitarId,noUpgrade,finalScore,breakdown}) {
  ...
  const best=noUpgrade?null:rec?.upgrade; // now findBestAvailable result with isCurrent flag
  // Si un meilleur preset est installé, on l'affiche directement
...
// Amp aliases: maps common ref_amp names to catalog amp names
const AMP_ALIASES={
  // Marshall
  "marshall super lead":"Marshall SL800","marshall super lead 100":"Marshall SL800","marshall plexi":"Marshall SL800","marshall 1959":"Marshall SL800","plexi":"Marshall Plexi",
  "marshall jcm800":"Marshall JCM800","marshall jcm 800":"Marshall JCM800","jcm800":"Marshall JCM800","jcm 800":"Marshall JCM800",
  "marshall jcm900":"Marshall JCM900","marshall jcm 900":"Marshall JCM900","jcm900":"Marshall JCM900","jcm 900":"Marshall JCM900",
  "marshall jtm45":"Marshall JTM45","marshall jtm 45":"Marshall JTM45","marshall jtm":"Marshall JTM45","jtm45":"Marshall JTM45","jtm 45":"Marshall JTM45",
  "marshall sl800":"Marshall SL800","marshall slt60":"Marshall SLT60",
  // Fender
  "fender twin reverb":"Fender Twin Silverface","fender twin":"Fender Twin Silverface","fender twin silverface":"Fender Twin Silverface","fender blackface twin":"Fender Twin Silverface",
  "fender deluxe reverb":"Fender Deluxe Reverb","fender deluxe":"Fender Deluxe",
  "fender bassman":"Fender Tweed Bassman","fender tweed bassman":"Fender Tweed Bassman","fender super reverb":"Fender Twin Silverface","fender super":"Fender Twin Silverface",
  "fender champ":"Fender Champ","fender concert":"Fender Concert","fender 5e3":"Fender Deluxe",
  // Vox
  "vox ac30":"Vox AC30","vox ac 30":"Vox AC30","vox ac30tb":"Vox AC30",
  // Mesa
  "mesa boogie dual rectifier":"Mesa Boogie Rectifier","mesa dual rectifier":"Mesa Boogie Rectifier","mesa rectifier":"Mesa Rectifier",
  "mesa boogie rectifier":"Mesa Boogie Rectifier","mesa boogie mark":"Mesa Mark IV","mesa mark iv":"Mesa Mark IV","mesa mark iic":"Mesa Mark IIC+","mesa mark 4":"Mesa Mark IV",
  // Orange
  "orange or120":"Orange Rockerverb","orange rockerverb":"Orange Rockerverb",
  // Friedman
  "friedman be-100":"Friedman BE-100","friedman be100":"Friedman BE-100","friedman be 100":"Friedman BE-100","friedman hbe":"Friedman HBE",
  // Bogner
  "bogner ecstasy":"Bogner Ecstasy","bogner shiva":"Bogner Ecstasy",
  // Dumble
  "dumble overdrive special":"Dumble ODS","dumble ods":"Dumble ODS","dumble":"Dumble Deluxe",
  // Divers
  "two rock":"Two Rock Stevie G","peavey 5150":"Peavey 5150","peavey evh":"Peavey 5150","evh 5150":"Peavey 5150",
  "hiwatt dr103":"Hiwatt HG100","hiwatt custom 100":"Hiwatt HG100","hiwatt":"Hiwatt HG100",
  "soldano slo":"Soldano SLO-100","soldano slo-100":"Soldano SLO-100","soldano slo 100":"Soldano SLO-100",
  "matchless dc30":"Matchless DC30","matchless dc 30":"Matchless DC30",
  "roland jc-120":"Roland JC-120","roland jc120":"Roland JC-120","roland jazz chorus":"Roland JC-120",
  // Laney
  "laney supergroup":"Laney Supergroup","laney super group":"Laney Supergroup","laney sg":"Laney Supergroup",
  "laney aor":"Laney AOR","laney gh100":"Laney GH100L","laney gh":"Laney GH100L",
  "laney vh100":"Laney VH100","laney vh":"Laney VH100",
  "laney vc50":"Laney VC50","laney vc30":"Laney VC30","laney vc":"Laney VC50",
  "laney lionheart":"Laney Lionheart","laney lion":"Laney Lionheart",
  "laney irt":"Laney IRT","laney":"Laney",
};
// Résout un ref_amp texte vers un nom canonique du catalogue via AMP_ALIASES
function resolveRefAmp(refAmp){
  ...
  // Cherche directement dans AMP_TAXONOMY
  if(AMP_TAXONOMY[refAmp]) return refAmp;
  return refAmp; // retourne tel quel si non trouvé
}
...
function computeBestPresets(gType,style,banksAnn,banksPlug,guitarId,refAmp,targetGain,availableSources){
  ...
  const scorePreset=(name,info,withBreakdown)=>{
    if(!guitarId) {
      // Sans guitare : utiliser le contexte morceau (style, gain, ref_amp) avec pickup statique
      ...
      let final=0;
      const breakdown={};
      for(const d of active){const ew=d.weight/totalWeight;final+=ew*d.score;breakdown[d.key]={raw:d.score,weight:Math.round(ew*100),contribution:Math.round(ew*d.score)};}
  ...
  // Best installed on pedal — diversify amps
  const annPresets=[];
  for(const [k,v] of Object.entries(banksAnn)){
    for(const c of ["A","B","C"]){
      if(v[c]){const info=findCatalogEntry(v[c]);if(info){
  ...
  // Best from full catalog — diversify amps (no 2 presets from same amp in top 3)
  // Filtre par sources possédées (ne pas recommander un preset d'un pack que je n'ai pas)
  ...
  // Add breakdown to top presets
  const addBreakdown=(p)=>{if(!p)return p;const info=findCatalogEntry(p.name);if(!info)return p;const r=scorePreset(p.name,info,true);return{...p,score:r.score!=null?r.score:p.score,breakdown:r.breakdown||null};};
  return {annTop:addBreakdown(annPresets[0])||null,plugTop:addBreakdown(plugPresets[0])||null,idealTop:catalogBest[0]||null,idealTop3:catalogBest};
}

// ─── fetchAI (helper partagé) ─────────────────────────────────────────────────
function enrichAIResult(aiResult,gType,gId,banksAnn,banksPlug,availableSources){
  ...
  // Si l'IA a proposé un ideal_preset depuis un pack non possédé, on l'oublie pour
  // forcer le remplacement par best.idealTop (qui respecte availableSources).
  ...
  // Idem pour le top3 : retire les entrées dont la source est décochée maintenant,
  // sinon la logique "never regress" plus bas garde l'ancien top3 si son score est
  // supérieur à la nouvelle version filtrée.
...
function bestScoreOf(r){return Math.max(r.preset_ann?.score||0,r.preset_plug?.score||0,r.ideal_preset_score||0);}
...
// Mise en cache avec mémoire du meilleur résultat par guitare (par dimension)
// Préserve les faits historiques (matériel original de l'artiste, infos morceau)
// — une optimisation ne doit JAMAIS réécrire ces faits, seulement la recommandation.
...
- ideal_guitar : DOIT être une guitare de la collection ci-dessus`;
  const key=aiKeys.gemini||aiKeys.anthropic||DEFAULT_GEMINI_KEY;
  const provider=(aiKeys.gemini||DEFAULT_GEMINI_KEY)?"gemini":"anthropic";
  ...
  const callAI=()=>{
    const req=provider==="gemini"
      ?fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-3-flash-preview:generateContent?key=${key}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:prompt}]}],generationConfig:{maxOutputTokens:4096}})})
        .then(r=>r.json()).then(d=>{if(d.error)throw new Error(d.error.message||d.error.status);return parse(d.candidates?.[0]?.content?.parts?.[0]?.text||"");})
      :fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":key,"anthropic-version":"2023-06-01","anthropic-dangerous-direct-browser-access":"true"},body:JSON.stringify({model:"claude-haiku-4-5-20251001",max_tokens:4096,messages:[{role:"user",content:prompt}]})})
        .then(r=>r.json()).then(d=>{if(d.error)throw new Error(d.error.message||d.error.type);return parse(d.content?.map(i=>i.text||"").join("")||"");});
  ...
  const tryBest=(currentBest,retries)=>{
    ...
    return callAI().then(newResult=>{
      return tryBest(mergeBestResults(currentBest,newResult),retries-1);
    }).catch(()=>currentBest);
  };
...
function FeedbackPanel({onSubmit,onCancel}){
  ...
  return <div style={{background:"var(--a4)",borderRadius:"var(--r-md)",padding:10,marginTop:6}}>
    <div style={{fontSize:11,color:"var(--text-muted)",marginBottom:6}}>Qu'est-ce qui ne va pas ? <span style={{fontSize:10,color:"var(--text-dim)"}}>(optionnel)</span></div>
    <div style={{display:"flex",gap:4,marginBottom:6,flexWrap:"wrap"}}>
      {FEEDBACK_TAGS.map(s=><button key={s} onClick={()=>setText(p=>p?p+", "+s:s)} style={{fontSize:9,background:text.includes(s)?"var(--accent)":"var(--a6)",color:text.includes(s)?"var(--text-inverse)":"var(--text-sec)",border:"1px solid var(--a10)",borderRadius:"var(--r-sm)",padding:"3px 7px",cursor:"pointer"}}>{s}</button>)}
    </div>
...
function MonProfilScreen({songDb,onSongDb,setlists,allSetlists,onSetlists,banksAnn,onBanksAnn,banksPlug,onBanksPlug,onBack,onNavigate,aiProvider,onAiProvider,aiKeys,onAiKeys,theme,onTheme,profile,profiles,onProfiles,activeProfileId,allGuitars,initTab,customGuitars,onCustomGuitars,toneNetPresets,onToneNetPresets,fullState,onImportState,onLogout}) {
  ...
  const addSongToDb=()=>{
    ...
    fetchAI(ns,"",banksAnn,banksPlug,aiProvider,aiKeys,allGuitars)
...
function MaintenanceTab({songDb,onSongDb,setlists,onSetlists,banksAnn,banksPlug,aiProvider,aiKeys,onFullReset}){
  ...
  const recalcAll=async()=>{
    ...
    for(let i=0;i<songDb.length;i++){
      ...
      try{
        const r=await fetchAI(s,"",banksAnn,banksPlug,aiProvider,aiKeys,GUITARS);
...
// ─── Modal Ajout Morceau ──────────────────────────────────────────────────────
function AddSongModal({songDb,onSongDb,setlists,onSetlists,activeSlId,onClose,banksAnn,banksPlug,aiProvider,aiKeys,guitars}) {
  ...
  const handleAdd=()=>{
    if(mode==="existing"){
      ...
      fetchAI(ns,"",banksAnn,banksPlug,aiProvider,aiKeys,guitars)
        .then(r=>onSongDb(p=>p.map(x=>x.id===ns.id?{...x,aiCache:updateAiCache(x.aiCache,"",r)}:x)))
        .catch(()=>{});
    }
    onClose();
      ...
      <div style={{background:"var(--bg-card)",borderRadius:"16px 16px 0 0",padding:20,width:"100%",maxWidth:700,maxHeight:"85vh",overflowY:"auto"}}>
        ...
        {mode==="existing"&&<>
          ...
          <div style={{maxHeight:200,overflowY:"auto",marginBottom:14}}>
            ...
            {filtered.map(s=>{const sel=selectedSongs.includes(s.id);return(
        ...
        {mode==="new"&&<div style={{marginBottom:14}}>
        ...
        <div style={{marginBottom:16}}>
          ...
          <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
            {setlists.map(sl=>{const sel=targetSlIds.includes(sl.id);return(
...
function getJamRecs(guitarId, style, banksAnn, banksPlug, guitars, availableSources){
  ...
  // Installed top 3 — diversify amps
  const pickTop3=(list)=>{const out=[];const amps=new Set();for(const p of list){if(!amps.has(p.amp)){out.push(p);amps.add(p.amp);}if(out.length>=3)break;}return out;};
  // Casse les ex-aequo visuels : si plusieurs items du top affichent le même score arrondi,
  // on bascule en affichage à une décimale (rawScore) pour rendre la variance lisible.
  ...
  // Full catalog top 3 — diversify amps, exclude already in installed tops
  const annNames=new Set(pickTop3(annInstalled).map(p=>p.name));
  const plugNames=new Set(pickTop3(plugInstalled).map(p=>p.name));
  const fullTop3=[];const fullAmps=new Set();
  for(const p of scored){
    if(fullAmps.has(p.amp)) continue;
    // Marquer si installé quelque part
...
// ─── SongDetailCard ──────────────────────────────────────────────────────────
function SongDetailCard({song,banksAnn,banksPlug,onBanksAnn,onBanksPlug,onClose,guitars,availableSources,savedGuitarId,onGuitarChange,aiProvider,aiKeys,onSongDb}){
  ...
  // Auto-trigger AI analysis if no cache for current guitar
  const needsRescore=song.aiCache?.sv!==SCORING_VERSION;
  useEffect(()=>{
    // Si localAiResult existe ET le scoring est à jour → rien à faire
    if(localAiResult&&!needsRescore) return;
    // Cache avec CoT → toujours rescore local (banques ou guitare ont pu changer)
    ...
    setReloading(true);
    fetchAI(song,gId,banksAnn,banksPlug,aiProvider,aiKeys,guitars)
      .then(r=>{
        setLocalAiResult(r);
  ...
  const handleGuitarChange=(v)=>{
    ...
    if(onSongDb){
      ...
      fetchAI(song,v,banksAnn,banksPlug,aiProvider,aiKeys,guitars)
        .then(r=>{
          setLocalAiResult(r);
  ...
  // "Recommandation idéale" : on score la guitare RÉELLEMENT affichée (ideal_guitar texte),
  // pas blindly cot[0] qui peut référer à une autre guitare. Cohérence avec "Mon choix".
  ...
  // Compute chosen guitar score from CoT step 2 — l'IA ne renvoie que le top 2-3, donc fallback local sinon
  ...
  return(
    <div className="song-row-detail" style={{background:"var(--bg-elev-1)",borderRadius:"0 0 12px 12px",padding:"10px 12px",marginBottom:8,marginTop:-2,display:"flex",flexDirection:"column",gap:6}}>
      ...
      <div style={sectionStyle}>
        ...
        {hist&&!aiC&&<div style={{fontSize:11,color:"var(--text-sec)",lineHeight:1.6}}>
      ...
      {/* ── Loading ── */}
      {reloading&&<div style={{textAlign:"center",padding:"16px 0"}}>
      ...
      {(aiC.cot_step1||aiC.cot_step2_guitars||aiC.cot_step3_amp)&&<div style={sectionStyle}>
      ...
      <div style={sectionStyle}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:6}}>
          {/* Guitare idéale */}
          {aiC.ideal_guitar&&<div style={{display:"flex",alignItems:"center",gap:6,fontSize:11}}>
          ...
          {aiC.ideal_preset&&(()=>{
            ...
            // Garde-fou : si le pack n'est plus possédé (cache antérieur au décochage),
            // on n'affiche pas la reco — l'utilisateur ne peut pas l'utiliser.
          ...
          {(()=>{
            ...
            {filteredTop3.slice(1).map((p,i)=>{
              ...
              const si=presetSourceInfo(entry);
              return <div key={i} style={{display:"flex",flexDirection:"column",gap:1,marginBottom:3}}>
          ...
          {/* Réglages idéaux */}
          {(aiC.settings_preset||aiC.settings_guitar)&&<div style={{marginTop:4,display:"flex",flexDirection:"column",gap:3}}>
      ...
      <div style={customSectionStyle}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:6}}>
          <div style={{display:"flex",alignItems:"center",gap:4}}><StatusDot score={aiC.preset_ann?.score} ideal={aiC.preset_ann?.label===aiC.ideal_preset} size={10}/><div style={{flex:1}}><PBlock device="Pedale" emoji="📦" presetName={aiC.preset_ann?.label} gType={gId?type:null} banks={banksAnn} availableSources={availableSources} guitarId={gId} noUpgrade finalScore={aiC.preset_ann?.score} breakdown={aiC.preset_ann?.breakdown}/></div></div>
          <div style={{display:"flex",alignItems:"center",gap:4}}><StatusDot score={aiC.preset_plug?.score} ideal={aiC.preset_plug?.label===aiC.ideal_preset} size={10}/><div style={{flex:1}}><PBlock device="ToneX Plug" emoji="🔌" presetName={aiC.preset_plug?.label} gType={gId?type:null} banks={banksPlug} availableSources={availableSources} guitarId={gId} noUpgrade finalScore={aiC.preset_plug?.score} breakdown={aiC.preset_plug?.breakdown}/></div></div>
        </div>
        ...
        {(()=>{
          ...
          var refAmp=aiC.ref_amp||"l'ampli original";
          var weakest=null;var weakLabel="";var weakScore=100;
          if(bestBreakdown){
            var dims=[
            ...
            dims.forEach(function(d){if(d.score!=null&&d.score<weakScore){weakScore=d.score;weakest=d.key;weakLabel=d.label;}});
          }
          // Chercher dans les catalogues externes (packs disponibles a l'achat)
          var extMatches=[];
          var refLower=(refAmp||"").toLowerCase();
          // D'abord chercher dans TSR_PACK_ZIPS (64 packs complets)
          if(typeof TSR_PACK_ZIPS!=="undefined"){
            for(var packName in TSR_PACK_ZIPS){
          ...
          // Puis les autres createurs via EXTERNAL_PACK_CATALOG
          if(typeof EXTERNAL_PACK_CATALOG!=="undefined"){
            EXTERNAL_PACK_CATALOG.forEach(function(creator){
              if(creator.creator==="The Studio Rats") return; // deja couvert par TSR_PACK_ZIPS
              creator.packs.forEach(function(pack){
                var match=pack.amps.some(function(a){return refLower.includes(a)||a.includes(refLower);});
                if(match){
                  var already=extMatches.find(function(e){return e.creator===creator.creator&&e.pack===pack.name;});
                  if(!already) extMatches.push({creator:creator.creator,url:creator.url,pack:pack.name});
                }
              });
            });
          }
          // Aussi chercher par famille dans AMP_TAXONOMY si pas de match direct
          if(extMatches.length===0&&typeof AMP_TAXONOMY!=="undefined"){
            var refTax=AMP_TAXONOMY[refAmp];
            if(refTax){
              // Chercher dans TSR_PACK_ZIPS par famille
              if(typeof TSR_PACK_ZIPS!=="undefined"){
                for(var pn in TSR_PACK_ZIPS){
                  var pnLower=pn.toLowerCase();
                  for(var ampName in AMP_TAXONOMY){
                    if(pnLower.includes(ampName.toLowerCase().split(" ")[0])&&AMP_TAXONOMY[ampName].family===refTax.family){
                      var alr=extMatches.find(function(e){return e.creator==="The Studio Rats"&&e.pack===pn;});
              ...
              // Chercher dans les autres createurs
              if(typeof EXTERNAL_PACK_CATALOG!=="undefined"){
                EXTERNAL_PACK_CATALOG.forEach(function(creator){
                  if(creator.creator==="The Studio Rats") return;
                creator.packs.forEach(function(pack){
                  pack.amps.forEach(function(a){
                    for(var ampName in AMP_TAXONOMY){
          ...
          return <div style={{marginTop:8,background:"rgba(251,191,36,0.06)",border:"1px solid rgba(251,191,36,0.2)",borderRadius:8,padding:"10px 12px"}}>
            ...
            {extMatches.length>0&&<div style={{marginBottom:6}}>
              <div style={{fontSize:10,fontWeight:700,color:"var(--text-muted)",marginBottom:4}}>Packs recommandes a l'achat :</div>
              {extMatches.map(function(e,i){return <div key={i} style={{fontSize:10,color:"var(--text-sec)",marginBottom:3,display:"flex",alignItems:"baseline",gap:4}}>
...
function ListScreen({songDb,onSongDb,setlists,allSetlists,onSetlists,checked,onChecked,onNext,onSettings,banksAnn,onBanksAnn,banksPlug,onBanksPlug,aiProvider,aiKeys,hideHeader=false,allGuitars,availableSources,activeProfileId}) {
  ...
  const deleteSetlist=id=>{
    ...
    const n=sl.songIds.length;
    if(!window.confirm(`Supprimer la setlist "${sl.name}" ?${n>0?"\nElle contient "+n+" morceau"+(n>1?"x":"")+" (les morceaux ne sont pas supprimés de la base).":""}`)) return;
    onSetlists(p=>p.filter(s=>s.id!==id));if(activeSlId===id){setActiveSlId(null);onChecked([]);}
  };
  ...
  const [improveStatus,setImproveStatus]=useState(null); // {current,total,round,songTitle}
  ...
  const improveAll=async()=>{
    ...
    setImproving(true);
    const guitars=allGuitars||GUITARS;
    // Race fetchAI against the cancel flag so "Arrêter" interrompt aussitôt l'attente IA
    ...
    for(let round=1;round<=IMPROVE_MAX_ROUNDS;round++){
      ...
      for(let i=0;i<toImprove.length;i++){
        ...
        try{
          const r=await waitOrCancel(fetchAI(s,gId,banksAnn,banksPlug,aiProvider,aiKeys,guitars));
          if(improveCancelRef.current) break;
  ...
  return (
    <div>
      ...
      <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:8}}>
        <select value={activeSlId||""} onChange={e=>{var v=e.target.value;setActiveSlId(v||null);onChecked([]);var ss=v&&setlists.find(s=>s.id===v)?.sort;setSort(ss&&ss!=="default"?ss:"artist");}} style={{flex:1,background:"var(--bg-card)",color:"var(--text-primary)",border:"1px solid var(--border-strong,var(--a15))",borderRadius:"var(--r-md)",padding:"8px 12px",fontSize:13,cursor:"pointer"}}>
      ...
      {showTopGuitars&&activeSongs.length>0&&(()=>{
          ...
          activeSongs.forEach(s=>{
            ...
            if(aiG){
              ...
              if(m){if(!songsByGuitar[m.id]) songsByGuitar[m.id]=new Set();songsByGuitar[m.id].add(s.id);matched=true;}
            }
            if(!matched){
              // Fallback: tester les presets pour chaque type et trouver le meilleur score
          ...
          return <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
            {ranked.map(({gId,count},i)=>{
              ...
              return <span key={gId} style={{fontSize:11,fontWeight:i===0?700:600,color:`rgb(${rgb})`,background:`rgba(${rgb},${i===0?0.15:0.08})`,border:`1px solid rgba(${rgb},${i===0?0.4:0.2})`,borderRadius:"var(--r-md)",padding:"4px 10px",display:"inline-flex",alignItems:"center",gap:4}}>
                {i===0&&"🏆 "}{g.short||g.name}
      ...
      {(()=>{let lastArtist="";return activeSongs.map(s=>{
        ...
        // Re-enrich only for expanded song (expensive: scans catalog). Collapsed rows use cached data as-is.
        ...
        const presetRow=(emoji,label,banks,overrideScore)=>{
          ...
          const scColor=sc!=null?scoreColor(sc):null;
          ...
          return(
            <div style={{display:"flex",alignItems:"center",gap:5}}>
              ...
              {sc!=null&&<span style={{fontFamily:"var(--font-mono)",fontSize:10,fontWeight:800,color:scColor,background:scBg,borderRadius:"var(--r-sm)",padding:"1px 6px",border:`1px solid ${scColor}30`}} title={scoreLabel(sc).tip}>{sc}%</span>}
            </div>
          );
        };
        return (
          ...
          <div style={{marginBottom: isExpanded?0:8}}>
            <div style={{display:"flex"}}>
              ...
              <div onClick={()=>{
                ...
                setExpandedId(newId);
                if(newId){
                  // Double rAF : attend que React ait rendu le SongDetailCard avant de scroller,
                  // sinon scrollIntoView se base sur la hauteur d'avant expansion et on finit
                  // au milieu/bas du contenu déplié.
                  requestAnimationFrame(()=>requestAnimationFrame(()=>{
                    const el=document.getElementById("song-"+s.id);
                    if(el){
                      var headerH=document.querySelector(".app-header-bar");
                      var offset=headerH?headerH.offsetHeight+8:60;
                ...
                {!isExpanded&&(g||aiC?.ideal_guitar)&&(()=>{
                  ...
                  return <div style={{display:"flex",alignItems:"center",gap:5,flexWrap:"wrap",marginTop:4}}>
...
function RecapScreen({songs,onBack,onNavigate,onValidate,songDb,onSongDb,banksAnn,banksPlug,aiProvider,aiKeys,allGuitars,availableSources}) {
  ...
  const rankedGuitars=useMemo(()=>{
    ...
    songs.forEach(s=>{
      ...
      if(!matched){
        const typeScores={HB:0,SC:0,P90:0};
        ["HB","SC","P90"].forEach(t=>{const pA=getPA(s,t);const pP=getPP(s,t);const name=pA?.l||pP?.l;if(name){const e=findCatalogEntry(name);if(e?.scores?.[t]) typeScores[t]=e.scores[t];}});
        const bestType=Object.entries(typeScores).sort((a,b)=>b[1]-a[1])[0]?.[0]||"HB";
        const matching=guitars.filter(g=>g.type===bestType);
        if(matching.length){if(!songsByGuitar[matching[0].id]) songsByGuitar[matching[0].id]=new Set();songsByGuitar[matching[0].id].add(s.id);}
      }
    });
    return Object.entries(songsByGuitar).map(([gId,sIds])=>({gId,count:sIds.size,songIds:[...sIds]})).sort((a,b)=>b.count-a.count);
  },[songs,guitars]);
  ...
  const songGuitarMap=useMemo(()=>{
    ...
    if(mode==="single"&&chosenGuitar){
      ...
      // Multi: assign best guitar per song from top 3
      const top3Ids=new Set(top3.map(r=>r.gId));
      songs.forEach(s=>{
        // Try ideal guitar from AI/ig
        const ig=getIg(s,guitars);
        const aiG=s.aiCache?.result?.ideal_guitar;
        let best=null;
        // Prefer a guitar that's in top 3
        ...
        // Fallback: best type match from top 3
        if(!best){
          const ai=s.aiCache?.result;
          const style=ai?.song_style||"rock";
          let bestScore=0;
  ...
  const songRows=useMemo(()=>{
    return songs.map(s=>{
      ...
      const gId=g?.id||"";
      const aiCraw=getBestResult(s,gId,s.aiCache?.result)||null;
      let presetAnn=null,presetPlug=null;
      if(aiCraw){
        var cleaned={...aiCraw,preset_ann:null,preset_plug:null,ideal_preset:null,ideal_preset_score:0,ideal_top3:null};
  ...
  const aiR=useMemo(()=>{const o={};songRows.forEach(({song,presetAnn,presetPlug})=>{const ai=song.aiCache?.result;if(ai) o[song.id]={...ai,preset_ann:presetAnn,preset_plug:presetPlug};});return o;},[songRows]);

  return (
    <div>
      <Breadcrumb crumbs={[{label:"Accueil",screen:"list"},{label:"Récap"}]} onNavigate={onNavigate}/>
      <div style={{marginBottom:20}}><div style={{fontFamily:"var(--font-display)",fontSize:"var(--fs-xl)",fontWeight:800,color:"var(--text-primary)"}}>Récap de session</div><div style={{fontSize:12,color:"var(--text-muted)",marginTop:3}}>{songs.length} morceau{songs.length>1?"x":""}</div></div>
      ...
      <div style={{background:"var(--a4)",border:"1px solid var(--green-border)",borderRadius:"var(--r-xl)",padding:16,marginBottom:20}}>
        {mode==="single"?(
          ...
          <div>
            ...
            {top3.length>0?<div style={{display:"flex",flexDirection:"column",gap:6}}>
              {top3.map(({gId,count,guitar},i)=>{
                const rgb=TYPE_COLORS[guitar.type]||"148,163,184";
                return <div key={gId} style={{display:"flex",alignItems:"center",gap:8,padding:"8px 10px",background:`rgba(${rgb},0.06)`,border:`1px solid rgba(${rgb},0.15)`,borderRadius:"var(--r-md)"}}>
            ...
            </div>:<div style={{fontSize:12,color:"var(--text-muted)"}}>Aucune guitare configurée</div>}
          </div>
        )}
      </div>
...
// ─── Synthesis Screen ─────────────────────────────────────────────────────────
function SynthesisScreen({songs,gps,aiR,onBack,onNavigate,songDb,banksAnn,banksPlug,allGuitars,availableSources}) {
  const rows=songs.map(s=>{
    const g=(allGuitars||GUITARS).find(x=>x.id===gps[s.id]);
    const type=g?.type||"HB";
    const gId=g?.id||"";
    let ann=null,plug=null;
    ...
    if(ai){
      if(ai.preset_ann){var recA=getInstallRec(ai.preset_ann.label,type,banksAnn,gId);ann={name:ai.preset_ann.label,score:ai.preset_ann.score,rec:recA};}
      if(ai.preset_plug){var recP=getInstallRec(ai.preset_plug.label,type,banksPlug,gId);plug={name:ai.preset_plug.label,score:ai.preset_plug.score,rec:recP};}
    }
    return {s,g,type,ann,plug};
  });
  ...
  return (
    <div>
      ...
      <div style={{overflowX:"auto",borderRadius:"var(--r-lg)",border:"1px solid var(--a8)"}}>
        <table>
          <thead><tr style={{background:"var(--a4)"}}><th style={th}>Morceau</th><th style={th}>Guitare</th><th style={{...th,color:"var(--text-sec)"}}>📦 Pedale</th><th style={{...th,color:"var(--accent)"}}>🔌 Plug</th></tr></thead>
          <tbody>
            {rows.map(({s,g,ann,plug},i)=>(
              <tr key={s.id} style={{background:i%2===0?"transparent":"var(--a3)"}}>
                ...
                <td style={td}>{cellPreset(ann,"var(--text-sec)")}</td>
                <td style={td}>{cellPreset(plug,"var(--accent)")}</td>
              </tr>
            ))}
          </tbody>
        </table>
...
function SetlistsScreen({songDb,onSongDb,setlists,allSetlists,onSetlists,checked,onChecked,onNext,onSettings,onNavigate,banksAnn,onBanksAnn,banksPlug,onBanksPlug,aiProvider,aiKeys,allGuitars,availableSources,activeProfileId}){
  ...
  return(
    <div>
      ...
      {tab==="setlists"&&<ListScreen songDb={songDb} onSongDb={onSongDb} allSetlists={allSetlists} setlists={setlists} onSetlists={onSetlists} checked={checked} onChecked={onChecked} onNext={onNext} onSettings={onSettings} banksAnn={banksAnn} onBanksAnn={onBanksAnn} banksPlug={banksPlug} onBanksPlug={onBanksPlug} aiProvider={aiProvider} aiKeys={aiKeys} hideHeader={true} allGuitars={allGuitars} availableSources={availableSources} activeProfileId={activeProfileId}/>}
      {tab==="songs"&&<div>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
        ...
        {(()=>{
          ...
          // Group by artist if sorted by artist
          let lastArtist="";
          return sorted.map(s=>{
          const expanded=expandedSongId===s.id;
...
// ─── SongSearchBar — free text → AI correction → validate ────────────────────
function SongSearchBar({onConfirm,aiProvider,aiKeys,songDb}){
  ...
  // Bug 10 — autocomplete : filtre la base locale en direct
  ...
  // Bug 9 — détecte les réponses non identifiées (titre/artiste "Inconnu" ou confiance basse)
...
Réponds UNIQUEMENT en JSON (sans markdown) : {"title":"Titre exact","artist":"Artiste/Groupe","confidence":"high|medium|low"}`;
  ...
  return(
    <div style={{position:"relative"}}>
      ...
      {showSuggest&&localSuggestions.length>0&&!suggestion&&!loading&&<div style={{position:"absolute",top:"54px",left:0,right:0,background:"var(--bg-elev-1)",border:"1px solid var(--border-strong)",borderRadius:"var(--r-lg)",boxShadow:"var(--shadow-md)",zIndex:50,maxHeight:240,overflowY:"auto"}}>
      ...
      {suggestion&&isUnknown&&<div style={{background:"var(--yellow-bg,rgba(251,191,36,0.12))",border:"1px solid var(--yellow-border,rgba(251,191,36,0.4))",borderRadius:"var(--r-lg)",padding:14,marginBottom:8}}>
      ...
      {suggestion&&!isUnknown&&<div style={{background:"var(--green-bg)",border:"1px solid var(--green-border)",borderRadius:"var(--r-lg)",padding:14,marginBottom:8}}>
  ...
  const steps=[
    ...
    ()=><div style={{textAlign:"center"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:10,textAlign:"left",padding:"4px 0"}}>
        ...
        ].map(({emoji,title,desc})=><div key={title} style={{display:"flex",gap:10,padding:"10px 12px",background:"var(--a3)",borderRadius:"var(--r-lg)"}}>
    ...
    ()=><div style={{textAlign:"center"}}>
      ...
      <div style={{fontSize:13,color:"var(--text-sec)",lineHeight:1.6,marginBottom:20}}>
        Pour des recommandations precises, l'app a besoin de connaitre :
      </div>
...
function HomeScreen({songDb,onSongDb,setlists,allSetlists,onSetlists,checked,onChecked,onNext,onSettings,onProfile,onSetlistScreen,onJam,onExplore,onOptimizer,banksAnn,banksPlug,aiProvider,aiKeys,allGuitars,availableSources,profiles,activeProfileId,onSwitchProfile,onProfiles,customPacks,syncStatus,onViewProfile,onLogout}) {
  ...
  const [songBaseAI,setSongBaseAI]=useState(null); // résultat AI brut (sans scores guitare)
  ...
  const rerunWithFeedback=()=>{
    ...
    fetchAI(song,gId,banksAnn,banksPlug,aiProvider,aiKeys,allGuitars,feedback.trim())
      .then(r=>{
        const pick=mergeBestResults(prev,r);
      ...
      <div style={{padding:"8px 0 4px",minHeight:(!songResult&&!songLoading)?"calc(100vh - 140px)":"auto",display:"flex",flexDirection:"column",justifyContent:(!songResult&&!songLoading)?"center":"flex-start"}}>
        ...
        <div style={{width:"100%"}}>
          <SongSearchBar songDb={songDb} aiProvider={aiProvider} aiKeys={aiKeys} onConfirm={(title,artist)=>{
            ...
            // On adopte le titre/artiste canoniques du doublon trouvé pour éviter d'afficher des variantes
            ...
            fetchAI(song,"",banksAnn,banksPlug,aiProvider,aiKeys,allGuitars)
              .then(r=>{
                setSongResult(r);setSongBaseAI(r);
                // Auto-sélectionne la guitare idéale (Bug 4 : "Guitare choisie" reflète un vrai choix)
                if(r.ideal_guitar){
                  const m=findGuitarByAIName(r.ideal_guitar,allGuitars);
                  if(m) setSelectedGuitar(m);
                }
        ...
        {/* Résultat — structure identique à SongDetailCard */}
        {songResult&&confirmedSong&&(()=>{
          ...
          // "Recommandation idéale" : on score la guitare RÉELLEMENT affichée (ideal_guitar texte),
          // pas blindly cot[0] qui peut référer à une autre guitare. Garantit la cohérence avec
          // "Mon choix" quand l'utilisateur a sélectionné la même guitare que l'idéale.
          ...
          const customSectionStyle={background:"var(--a5)",border:"1px solid var(--a10)",borderRadius:"var(--r-lg)",padding:"10px 12px",marginBottom:8};
          const sectionTitle=(icon,label)=><div style={{fontSize:10,fontWeight:700,color:"var(--text-muted)",fontFamily:"var(--font-mono)",textTransform:"uppercase",letterSpacing:"var(--tracking-wider)",marginBottom:8,display:"flex",alignItems:"center",gap:5}}>{icon} {label}</div>;
          return <div style={{width:"100%",maxWidth:500,animation:"slideDown .2s ease-out"}}>
          <div style={{background:"var(--bg-elev-1)",border:"1px solid var(--a7)",borderRadius:"var(--r-xl)",padding:14,marginTop:8,display:"flex",flexDirection:"column",gap:6}}>
            ...
            <div style={sectionStyle}>
              ...
              {(songResult.ref_guitarist||songResult.ref_guitar||songResult.ref_amp)&&<div style={{fontSize:11,color:"var(--text-sec)",lineHeight:1.6}}>
            ...
            {/* SECTION 2 : Raisonnement IA */}
            {(songResult.cot_step1||songResult.cot_step2_guitars||songResult.cot_step3_amp)&&<div style={sectionStyle}>
              ...
              {showCotSearch&&<div style={{marginTop:8,display:"flex",flexDirection:"column",gap:8}}>
            ...
            {/* SECTION 3 : Recommandation idéale */}
            <div style={sectionStyle}>
              {sectionTitle(<StatusDot score={100} ideal={true} size={10}/>,"Recommandation ideale")}
              <div style={{display:"flex",flexDirection:"column",gap:6}}>
                {songResult.ideal_guitar&&<div style={{display:"flex",alignItems:"center",gap:6,fontSize:11}}>
                  <StatusDot score={idealGuitarScore} ideal={true}/>
                ...
                {songResult.ideal_preset&&(()=>{
                  ...
                  // Garde-fou : ne pas afficher si la source est décochée
                  if(availableSources&&entry?.src&&availableSources[entry.src]===false) return null;
                  const srcInfo=presetSourceInfo(entry);
                  return <div>
                ...
                {(songResult.settings_preset||songResult.settings_guitar)&&<div style={{marginTop:4,display:"flex",flexDirection:"column",gap:3}}>
            ...
            <div style={customSectionStyle}>
              ...
              <div style={{marginBottom:8}}>
                ...
                {showGuitarPick&&<div style={{marginBottom:8,background:"var(--a4)",borderRadius:"var(--r-md)",padding:10}}>
                  <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
            ...
            {/* Affiner */}
            {!showFeedback?<button onClick={()=>setShowFeedback(true)} style={{fontSize:10,background:"none",border:"1px solid var(--a10)",color:"var(--text-dim)",borderRadius:"var(--r-md)",padding:"3px 8px",cursor:"pointer"}}>🔄 Affiner l'analyse</button>
...
function App() {
  ...
  const applyRemoteData = (data) => {
    ...
    if(data.profiles) setProfiles(prev=>{
      const next=applySecrets(data.profiles);
  ...
  else if(screen==="synthesis"&&synth) screenContent=<SynthesisScreen songs={songs} gps={synth.gps} aiR={synth.aiR} onBack={()=>setScreen("recap")} onNavigate={setScreen} songDb={songDb} banksAnn={banksAnn} banksPlug={banksPlug} allGuitars={allGuitars} availableSources={availableSources}/>;
  else if(screen==="recap") screenContent=<RecapScreen songs={songs} onBack={()=>setScreen("list")} onNavigate={setScreen} onValidate={(gps,aiR)=>{setSynth({gps,aiR});setScreen("synthesis");}} songDb={songDb} onSongDb={setSongDb} banksAnn={banksAnn} banksPlug={banksPlug} aiProvider={aiProvider} aiKeys={aiKeys} allGuitars={allGuitars} availableSources={availableSources}/>;
